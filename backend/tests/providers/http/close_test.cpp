...
static ph::HttpTransportFn fx(uint64_t t){return[=](const ph::HttpTransportRequest& r)->ph::HttpTransportResponse{ph::HttpTransportResponse o;if(r.range_start.has_value()){o.status=206;o.headers["Content-Range"]="bytes "+std::to_string(*r.range_start)+"-0/"+std::to_string(t);}return o;};}
