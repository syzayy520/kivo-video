...
P2-001A/B/C through P2-019 DONE. Proceed to P2-020 Minimal UserPerceivedQualitySnapshot:

1. UserPerceivedQualitySnapshot contract.
2. Fake service and test.
