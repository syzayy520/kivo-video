...
4. `P2-SOURCE-RUNTIME-FINAL-CLOSURE-003`
...
- `artifacts/p2/evidence/P2-SOURCE-RUNTIME-FINAL-CLOSURE-003.json`
- `docs/execution_cards/P2_SOURCE_RUNTIME_FINAL_CLOSURE_003.md`
...
P2 final closure canonical source:

- closure-003 / `9ac330a492c0449d5f738c447ad0ceb9238972ab`
- Branch: `kivo-video-p2-source-runtime-final-closure-003`
- Base: `c90cfdc938cd21e6ecf6d62d1b088d0d0fe3b9a1`
- closure-001 and closure-002 are rejected historical attempts.
- They must not be used as P3 dependency.

Forbidden:

- Starting P3 implementation if P2 closure is absent.
- Using P3 to repair unfinished P2 source runtime gates.
- Using closure-001 or closure-002 as P3 dependency.

STOP if:

- P2 final closure evidence/card is missing, invalid, or still in TODO state.
- closure-001 or closure-002 is used as the P3 dependency source.
