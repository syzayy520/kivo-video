...
- P2 Source Runtime Final Closure V7 task book added as `P2-SOURCE-RUNTIME-FINAL-CLOSURE-001`. Full canonical id: `KIVO-VIDEO-P2-SOURCE-RUNTIME-FINAL-CLOSURE-001`. Execution card: `docs/roadmap/p2_source_runtime_final_closure_001_execution_card.md`. This is queued after `REMOTE-RANGE-RUNTIME-HTTP-WEBDAV-001` and is the isolated-worktree final closure / baseline-lock task, not new source runtime feature work.
- P3 Complete Line v9 Closure-Ready task book added as `P3-COMPLETE-LINE-V9`. Canonical planning id: `KIVO-VIDEO-P3-COMPLETE-LINE-DESIGN-PLANNING-V9`. Execution card: `docs/roadmap/p3_complete_line_v9_closure_ready_execution_card.md`. This is queued after `P2-SOURCE-RUNTIME-FINAL-CLOSURE-001` and contains its own `FC-001` through `FC-101` gates for the Source Runtime -> Playback-Ready Input System bridge.
...
8. After `REMOTE-RANGE-RUNTIME-HTTP-WEBDAV-001` is complete, execute `P2-SOURCE-RUNTIME-FINAL-CLOSURE-001` from `docs/roadmap/p2_source_runtime_final_closure_001_execution_card.md`.
9. After `P2-SOURCE-RUNTIME-FINAL-CLOSURE-001` is complete and P2 is closed, execute `P3-COMPLETE-LINE-V9` from `docs/roadmap/p3_complete_line_v9_closure_ready_execution_card.md`.
